...
from .tools.tools import add_data, create_corpus, delete_corpus, delete_document, get_corpus_info, list_corpora, rag_query

root_agent = Agent(
    name="RagAgent",
    # Using Gemini 2.5 Flash for best performance with RAG operations, but other models can be used as well including openAI models.
